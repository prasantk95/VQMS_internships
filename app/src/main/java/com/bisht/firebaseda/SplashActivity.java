 ...
 */
        ...
        import com.bisht.firebaseda.R;
        import com.bisht.firebaseda.KenBurnsView;
...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mKenBurns.setImageResource(R.drawable.back);

        new Handler().postDelayed(new Runnable() {

            @Override
            public void run() {
                Intent i = new Intent(SplashActivity.this, Front1.class);
                startActivity(i);
